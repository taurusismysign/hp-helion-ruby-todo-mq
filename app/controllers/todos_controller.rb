...
class TodosController < ApplicationController
  ...
  def new
    @todo = Todo.new
    @categories = Category.get_all_from_service
  end
  ...
  def todo_params
    params.require(:todo).permit(:description, :is_completed, :target_date, :category, :notify_email)
  end

  def get_redis_connection

    Redis.new(:url => ConnectionMgmt.get("REDIS"))
